                                ...
                                <nav>
                                    <ul class="header__nav">
                                                ...
                                                <li class="mega-menu__box">
                                                    ...
                                                    <div class="mega-menu__item-box">
                                                        ...
                                                        <ul class="mega-menu__item">
                                                            <li class="mega-menu__list"><a href="shop-sidebar-grid-left.php" class="mega-menu__link">Grid Left Sidebar</a></li>
                                                            <li class="mega-menu__list pos-relative">
                                                                <a href="shop-sidebar-grid-right.php" class="mega-menu__link">Grid Right Sidebar</a>
                                                                <span class="menu-label menu-label--red">New</span>
                                                            </li>
                                                            <li class="mega-menu__list"><a href="shop-sidebar-full-width.php" class="mega-menu__link">Full Width</a></li>
                                                            <li class="mega-menu__list"><a href="shop-sidebar-left-list-view.php" class="mega-menu__link">List Left Sidebar</a></li>
                                                            <li class="mega-menu__list"><a href="shop-sidebar-right-list-view.php" class="mega-menu__link">List Right Sidebar</a></li>
                                                        </ul>
                                                    </div>
                                                    <!--Single Megamenu Item Menu-->
                                                    ...
                                                    <div class="mega-menu__item-box">
                                                        ...
                                                        <ul class="mega-menu__item">
                                                            ...
                                                            <li class="mega-menu__list"><a href="compare.php" class="mega-menu__link">Compare</a></li>
                                                            <li class="mega-menu__list pos-relative">
                                                                <a href="empty-cart.php" class="mega-menu__link">Empty Cart</a>
                                                            ...
                                                            <li class="mega-menu__list"><a href="my-account.php" class="mega-menu__link">My Account</a></li>
                                                            <li class="mega-menu__list"><a href="login.php" class="mega-menu__link">Login</a></li>
                                                        </ul>
                                                    </div>
                                                    <!--Single Megamenu Item Menu-->
                                                    ...
                                                    <div class="mega-menu__item-box">
                                                        ...
                                                        <ul class="mega-menu__item">
                                                            <li class="mega-menu__list"><a href="product-single-default.php" class="mega-menu__link">Simple</a></li>
                                                            <li class="mega-menu__list"><a href="product-single-affiliate.php" class="mega-menu__link">Affiliate</a></li>
                                                            <li class="mega-menu__list pos-relative">
                                                                <a href="product-single-group.php" class="mega-menu__link">Grouped</a>
                                                                <span class="menu-label menu-label--red">New</span>
                                                            </li>
                                                            <li class="mega-menu__list"><a href="product-single-variable.php" class="mega-menu__link">Variable</a></li>
                                                            <li class="mega-menu__list"><a href="product-single-tab-left.php" class="mega-menu__link">Left Tab</a></li>
                                                            <li class="mega-menu__list"><a href="product-single-tab-right.php" class="mega-menu__link">Right Tab</a></li>
                                                        </ul>
                                                    </div>
                                                    <!--Single Megamenu Item Menu-->
                                                    ...
                                                    <div class="mega-menu__item-box">
                                                        <span class="mega-menu__title">Product Single</span>
                                                        <ul class="mega-menu__item">
                                                            <li class="mega-menu__list"><a href="product-single-slider.php" class="mega-menu__link">Single Slider</a></li>
                                                            <li class="mega-menu__list"><a href="product-single-gallery-left.php" class="mega-menu__link">Gallery Left</a></li>
                                                            <li class="mega-menu__list"><a href="product-single-gallery-right.php" class="mega-menu__link">Gallery Right</a></li>
                                                            <li class="mega-menu__list"><a href="product-single-sticky-left.php" class="mega-menu__link">Sticky Left</a></li>
                                                            <li class="mega-menu__list pos-relative">
                                                                <a href="product-single-sticky-right.php" class="mega-menu__link">Sticky Right</a>
                                                                <span class="menu-label menu-label--blue">New</span>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div class="mega-menu__item-box">
                                                        <ul class="mega-menu__item">
                                                            ...
                                                            <li class="mega-menu__banner ">
                                                                <a href="product-single-default.php" class="mega-menu__banner-link">
                                            ...
                                            <ul class="dropdown__menu pos-absolute">
                                                <li class="dropdown__list">
                                                    ...
                                                    <ul class="dropdown__submenu pos-absolute">
                                                        <li class="dropdown__submenu-list"><a href="blog-grid-sidebar-left.php" class="dropdown__submenu-link"> Blog Grid Left Sidebar</a></li>
                                                        <li class="dropdown__submenu-list"><a href="blog-grid-sidebar-right.php" class="dropdown__submenu-link"> Blog Grid Right Sidebar</a></li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown__list">
                                                    <a href="#" class="dropdown__link d-flex justify-content-between align-items-center">Blog List <i class="far fa-chevron-right"></i></a>
                                                    <ul class="dropdown__submenu pos-absolute">
                                                        <li class="dropdown__submenu-list"><a href="blog-list-sidebar-left.php" class="dropdown__submenu-link"> Blog List Left Sidebar</a></li>
                                                        <li class="dropdown__submenu-list"><a href="blog-list-sidebar-right.php" class="dropdown__submenu-link"> Blog List Right Sidebar</a></li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown__list">
                                                    ...
                                                    <ul class="dropdown__submenu pos-absolute">
                                                        <li class="dropdown__submenu-list"><a href="blog-single-sidebar-left.php" class="dropdown__submenu-link"> Blog Single Left Sidebar</a></li>
                                                        <li class="dropdown__submenu-list"><a href="blog-single-sidebar-right.php" class="dropdown__submenu-link"> Blog Single Right Sidebar</a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                            <!--Single Dropdown Menu-->
                                        ...
                                        <li class="header__nav-item pos-relative">
                                            ...
                                            <!--Single Dropdown Menu-->
                                            <ul class="dropdown__menu pos-absolute">
                                                <li class="dropdown__list"><a href="about.php" class="dropdown__link">About Us</a></li>
                                                <li class="dropdown__list pos-relative">
                                                    <a href="frequently-questions.php" class="dropdown__link">Frequently Questions</a>
                                                    <span class="menu-label menu-label--blue">New</span>
                                                </li>
                                                <li class="dropdown__list"><a href="privacy-policy.php" class="dropdown__link">Privacy Policy</a></li>
                                                <li class="dropdown__list"><a href="404.php" class="dropdown__link">404 Page</a></li>
                                            </ul>
                                            <!--Single Dropdown Menu-->
                                        </li> <!-- End Single Nav link-->
            ...
            <div class="row">
                <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-4 offset-lg-4">
                    <div class="page-not-found text-center">
                        ...
                        <a href="index.php" class="btn btn--icon-left btn--small btn--radius-tiny btn--green btn--green-hover-black font--bold text-capitalize m-t-20">GO TO HOME PAGE</a>
                    </div>
                </div>
            </div>
        </div>
